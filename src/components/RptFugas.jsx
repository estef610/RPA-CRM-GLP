...
const RptFugas = () => {
    const [flVale, setFlVale] = React.useState(951)
    ...
    return (
        <div className="container">
            ...
            <form action="">
                ...
                <input type="text" className="form mb-2 mr-2" placeholder="Id Tanque" />
                <br /><br />
                ...
                <input type="text" className="form-control mb-2" placeholder="Reporte de Operador" />
                <br />
                <button
